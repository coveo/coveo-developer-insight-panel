...
function createSidebarCoveoInsight() {
  chrome.devtools.panels.elements.createSidebarPane('Coveo',
    function (sidebar) {
...
function createSidebarCoveoResults() {
  chrome.devtools.panels.elements.createSidebarPane('Coveo Results',
    function (sidebar) {
...
function createSidebarCoveoTemplates() {
  chrome.devtools.panels.elements.createSidebarPane('Coveo Templates',
    function (sidebar) {
...
function createSidebarCoveoComponents() {
  chrome.devtools.panels.elements.createSidebarPane('Coveo Components',
    function (sidebar) {
